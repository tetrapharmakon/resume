...
\newlength{\Pad}\setlength{\Pad}{14.562pt} % 1.618 * 9pt
\newlength{\Row}\setlength{\Row}{1.25in}
\newlength{\Col}\setlength{\Col}{\dimexpr 1.618\Row\relax}
...
\AddToShipoutPictureFG{%
  \begin{tikzpicture}[remember picture,overlay]
    \node [
      ...
      ] at (2\Pad,\pdfpageheight-3\Pad-\Row-1.5pt) % NOTE: 1.5pt is for vertical alignment with first header
      {
