...
\NewDocumentCommand{\SimpleEvent}{mmom}
  {%
{\bfseries#1}\hfill#2\IfValueT{#3}{\textcolor{Muted}{, #3}}\quad#4\vspace{-3pt}}
...
\definecolor{Base}{HTML}{3D1362}
\colorlet{HBar}{violet}
\colorlet{VBar}{black}
...
\SimpleEvent
  ...
  {\llap{\textsuperscript{\tiny\color{HBar}\Fa{Link}}}%
