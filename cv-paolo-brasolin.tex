...
\geometry{
  a4paper,
  % letterpaper,
  top=\dimexpr\Row+\Pad+1.618\Pad-\SectionStrutHeight\relax,
  left=\dimexpr\Pad+\Col+1.618\Pad\relax,
...
% \definecolor{Base}{HTML}{3D1362} % {Hsb}{272,0.81,0.38}
\colorlet{VBar}{black}
...
\AddToShipoutPictureBG{%
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node [
        ...
        color=white,
        inner sep=0,
      ] at (\Pad+\Col+1.618\Pad+0.5\textwidth,\pdfpageheight-\Pad-.5\Row)
...
\AddToShipoutPictureFG{%
  \begin{tikzpicture}[remember picture,overlay]
    \node [
      ...
      ] at (2\Pad,\pdfpageheight-\Pad-\Row-1.618\Pad+\SectionStrutHeight)
      {
